...
public class AdminListener implements ActionListener {
    ...
    //es el evento que ocurrio en este caso trae el boton apretado que KEY en la tabla 
    @Override
    public void actionPerformed(ActionEvent e) {
	IController controller = componentControllerMap.get(e.getSource());//me da el controlador del evnto
	if (null != controller) {
