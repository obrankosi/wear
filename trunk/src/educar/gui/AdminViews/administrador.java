...
public class administrador extends JFrame implements IView, defaultLanguaje {
	...
	public administrador() {
		...
		menuDedicacionDocente
				.addTab("MODIFICAR DEDICACION DOCENTE",
						new ImageIcon(
								administrador.class
		...
		menuDedicacionDocente
				.addTab("ALTA DEDICACION DOCENTE",
						new ImageIcon(
								administrador.class
										.getResource("/educar/gui/AdminViews/imagenIcon/dedicacion Docente.png")),
		...
		btnLimpiarEncargadoAsignacionMateria = new JButton("LIMPIAR");
		...
		btnGuardarEncargadoAsignacionMateria = new JButton("GUARDAR");
		...
		listaMateriaEncargadoAsignacionMateria = new List();
		listaMateriaEncargadoAsignacionMateria.setBounds(591, 81, 267, 514);
		panelEncargadoAsignacionDocente
				.add(listaMateriaEncargadoAsignacionMateria);

		btnBorrarEncargadoAsignacionMateria = new JButton("BORRAR");
		...
		listaDocenteEncargadoAsignacionMateria = new List();
		listaDocenteEncargadoAsignacionMateria.setBounds(869, 81, 267, 514);
		panelEncargadoAsignacionDocente
				.add(listaDocenteEncargadoAsignacionMateria);
		...
		listaMateriaDesignacionAsignacionDocente = new List();
		listaMateriaDesignacionAsignacionDocente.setBounds(591, 81, 267, 514);
		panelDesignacionAsignacionDocente
				.add(listaMateriaDesignacionAsignacionDocente);
		...
		listaDocenteDesignacionAsignacionDocente = new List();
		listaDocenteDesignacionAsignacionDocente.setBounds(869, 81, 267, 514);
		panelDesignacionAsignacionDocente
				.add(listaDocenteDesignacionAsignacionDocente);
	...
	// ////////////////////////// DEDICACION DOCENTE /////////////// GET AND SET
	// //////////

	// ---------------- get y set del panel modificar -------------
	...
	// ////////////////////////// ASIGNACION MATERIA GET Y SET
	// /////////////////////////////

	public void setMateriaEncargadoAsignacionMateria(String s) {
		txtFMateriaEncargadoAsignacionMateria.setText(s);
	}

	public void setDocenteEncargadoAsignacionMateria(String s) {
		txtFDocenteEncargadoAsignacionMateria.setText(s);
	}

	public void setDniEncargadoAsignacionMateria(String s) {
		txtFDniEncargadoAsignacionMateria.setText(s);
	}

	public String getMateriaEncargadoAsignacionMateria() {
		return txtFMateriaEncargadoAsignacionMateria.getText();
	}

	public String getDocenteEncargadoAsignacionMateria() {
		return txtFDocenteEncargadoAsignacionMateria.getText();
	}

	public String getDniEncargadoAsignacionMateria() {
