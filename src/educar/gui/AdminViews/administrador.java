...
public class administrador extends JFrame implements IView,defaultLanguaje {
	...
	private JTextField txtFBuscarDniModificarAlmuno;
	...
	private JTextField txtFNombeAltaDocente;
	...
	public administrador() {
		setVisible(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(administrador.class.getResource("/educar/gui/AdminViews/imagenIcon/admin.png")));
				...
				.createParallelGroup(Alignment.TRAILING).addGroup(
						...
						gl_administrador
								...
								.addComponent(menuAcciones,
										...
										Short.MAX_VALUE)));
		gl_administrador.setVerticalGroup(gl_administrador
				.createParallelGroup(Alignment.LEADING)
				.addComponent(menuAdminScroll)
				.addComponent(menuAcciones, Alignment.TRAILING,
		...
		gl_menuAcciones.setVerticalGroup(gl_menuAcciones.createParallelGroup(
				...
				.addGroup(
						gl_menuAcciones
								.createSequentialGroup()
								.addGap(2)
								.addComponent(menuAccionesScroll,
...
///////////////////////////////////////////////// ALTA DOCENTE ////////////////////////
		...
		menuDocente
				.addTab("                           ALTA DOCENTE                            ",
						new ImageIcon(administrador.class.getResource("/educar/gui/AdminViews/imagenIcon/docentepng.png")),
		...
		panelAltaDocente.add(txtFDniAltaAlumno);
		...
		panelModificacionDocente.setBackground(SystemColor.activeCaption);
		menuDocente
				.addTab("                         MODIFICACION DOCENTE                            ",
						new ImageIcon(administrador.class.getResource("/educar/gui/AdminViews/imagenIcon/docentepng.png")),
						panelModificacionDocente, null);

		JLabel lblCartelModificarDocente = new JLabel("Buscar Docente a Modificar");
		...
		lblApellidoModificarDocente.setHorizontalAlignment(SwingConstants.CENTER);
		...
		lblDireccionModificarDocente.setHorizontalAlignment(SwingConstants.CENTER);
		...
		lblFechaNacModificarDocente.setHorizontalAlignment(SwingConstants.CENTER);
		...
		lblTelefonoModificarDocente.setHorizontalAlignment(SwingConstants.CENTER);
		...
		btnGuardarModificarDocente = new JButton(ADD);
    ...
    ///////////////////////////////      MODIFICAR FACULTAD ///////////////////////////////////////////////////////////////////
		...
		menuFacultad
				.addTab("                      MODIFICAR FACULTAD                         ",
						new ImageIcon(administrador.class.getResource("/educar/gui/AdminViews/imagenIcon/facultadespng.png")),
						panelModificarFacultad, null);

		JLabel lblCartelModificarFacultad = new JLabel("Inserte el Codigo de la Facultad ");
		lblCartelModificarFacultad.setHorizontalAlignment(SwingConstants.CENTER);
		...
		lblCodigoModificarFacultad.setHorizontalAlignment(SwingConstants.CENTER);
		...
		lblNombreModificarFacultad.setHorizontalAlignment(SwingConstants.CENTER);
...
//////////////////////////////////////////////   panel MODIFICAR ALUMNO   /////////////////////////////
		...
		menuAlumno
				.addTab("                           MODIFICAR ALUMNO                         ",
						new ImageIcon(administrador.class.getResource("/educar/gui/AdminViews/imagenIcon/alumnopng.png")),
		...
		lblListaAlumnoModificarAlumno.setHorizontalAlignment(SwingConstants.CENTER);
		...
		listaModificarAlumno.add("gringo culiado");
		...
		lblApellidoModificarAlumno.setHorizontalAlignment(SwingConstants.CENTER);
		...
		lblDireccionModificarAlumno.setHorizontalAlignment(SwingConstants.CENTER);
		...
		lblFecharNacModificarAlumno.setHorizontalAlignment(SwingConstants.CENTER);
		...
		lblTelefonoModificarAlumno.setHorizontalAlignment(SwingConstants.CENTER);
		...
		btnGuardarModificarAlumno = new JButton(ADD);
		...
		menuAlumno
				.addTab("                            ALTA ALUMNO                           ",
						new ImageIcon(administrador.class
								.getResource("/imagenIcon/alumnopng.png")),
						panelAltaAlumno, null);

		JLabel lblCartelAltaAlumno = new JLabel("Inserte los Datos del Alumno a dar de Alta");
...
///////////////////////////////////////////////////////////////      PANEL DE MODIFICAR CARGO ////////////
		...
		menuCargo
				.addTab("                          MODIFICAR CARGO                          ",
						new ImageIcon(administrador.class.getResource("/educar/gui/AdminViews/imagenIcon/cargospng.png")),
		...
		JLabel lblCartelAltaCargo = new JLabel("Inserte el Nombre del Cargo  a Guardar");
...
////////////////////////////////////   MODIFICAR MATERIA //////////////////////////
		...
		menuMateria
				.addTab("                             MODIFICAR MATERIA                          ",
						new ImageIcon(administrador.class.getResource("/educar/gui/AdminViews/imagenIcon/materiapng.png")),
...
/////////////////////////////////////////   ALTA MATERIA ////////////////////////////////////////////////////////
		...
		btnAlumnos.setBackground(new Color(204, 204, 255));
		btnAlumnos.setBounds(10, 32, 159, 70);
		btnAlumnos.setForeground(new Color(51, 51, 102));
	...
	// hace pone el numero de documento en la pestaña buscar de dicha trabbla
	/*
